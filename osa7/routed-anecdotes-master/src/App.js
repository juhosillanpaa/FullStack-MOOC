...
const Menu = () => {
  ...
  return (
    <div>
      ...
      <Link to = '/create' href='#' style={padding}>create new</Link>
      <Link to = '/about' href='#' style={padding}>about</Link>
    </div>
  )
}
...
const Anecdote = ({ anecdote }) => {
  ...
  return (
    <div>
      ...
      <p>written by {anecdote.author}</p>
...
const CreateNewNoHistory = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.history.push('/')
    props.showNotification(`Anecdote ${content} added succesfully`)
  }
    ...
    <div>
      <Router>
        <div>
          ...
          <Route exact path = '/create' render = {() => <CreateNew addNew={addNew} showNotification = {setNotification} /> } />
          <Footer />
        </div>
      </Router>
    </div>
